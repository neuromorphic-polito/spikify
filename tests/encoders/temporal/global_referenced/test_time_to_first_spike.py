import unittest
import numpy as np
from spikify.encoders.temporal.global_referenced.time_to_first_spike_algorithm import (
    time_to_first_spike,
)
...
class TestTimeToFirstSpike(unittest.TestCase):
    ...
    def test_with_multiple_features(self):
        ...
        signal_f1 = signal[:, 0]
        signal_f2 = signal[:, 1]
        encoded_signal_f1 = time_to_first_spike(signal_f1, interval)
        encoded_signal_f2 = time_to_first_spike(signal_f2, interval)
