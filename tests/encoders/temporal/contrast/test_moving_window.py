import unittest
import numpy as np
from spikify.encoders.temporal.contrast.moving_window_algorithm import moving_window
...
class TestMovingWindow(unittest.TestCase):
    ...
    def test_window_length_greater_than_signal(self):
        """Test the function when the window length is greater than the signal length."""
