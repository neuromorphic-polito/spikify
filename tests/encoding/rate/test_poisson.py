import unittest
import numpy as np
from spikify.encoding.rate.poisson_algorithm import poisson


class TestPoissonRateEncoding(unittest.TestCase):
    """Tests for the poisson function."""
    ...
    def test_shape_with_multiple_features(self):
        ...
        interval = 2
        encoded_signal = poisson(signal, interval)
